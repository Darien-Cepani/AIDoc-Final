  	...
  	extend: {
  		colors: {
  			...
  			sidebar: { 
                ...
                'muted-foreground': 'hsl(var(--sidebar-muted-foreground-hsl))',
                'accent-background': 'hsl(var(--sidebar-accent-background-hsl))',
                'accent-foreground': 'hsl(var(--sidebar-accent-foreground-hsl))',
                'destructive-background': 'hsl(var(--sidebar-destructive-background-hsl))',
                'destructive-foreground': 'hsl(var(--sidebar-destructive-foreground-hsl))',
  			}
  		},
  		borderRadius: {
